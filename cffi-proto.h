...
void pysimul_set_var_float (struct simul_thread_info_t*, uint8_t preinit, const char* key, double val);
void pysimul_set_var_integer (struct simul_thread_info_t*, uint8_t preinit, const char* key, int64_t val);
void pysimul_set_var_string (struct simul_thread_info_t*, uint8_t preinit, const char* key, const char* cstr);
